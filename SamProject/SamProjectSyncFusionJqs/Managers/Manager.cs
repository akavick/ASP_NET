...
using SamProjectSyncFusionJqs.Managers;
using SamProjectSyncFusionJqs.Models;
using SamProjectSyncFusionJqs.Repositories;





namespace SamProjectSyncFusionJqs.Managers
{
            ...
            return await Task.Run(() =>
            {
                ...
                var columnChart =
                    _repository.ReservationSystemApplications
                               .Where(app => app.IntersectsWith(application/*dateSpan*/))
