    ...
    public class Repository : IRepository
    {
        ...
        static Repository()
        {
            ...
            _reservationSystemApplications = new []
            {
                ...
                new RsApplication{ Id = 2,  Number = "6898", Department = "PC09", Market = "DE", ApplicationStatus = new RsApplicationStatus{ Type = RsApplicationStatusType.Approved }, Project = _projects[1], Candidate = _people[0], ProjectManager = _people[4], Smd = _people[4], CandidateDescription = description, Specialty = new Specialty{ Type = SpecialtyType.Developer }, Qualification = new Qualification{ Type = QualificationType.Senior}, Rate = _rates[0], BeginDate = new DateTime(2018, 1, 8),  EndDate = new DateTime(2018, 1, 8)   },
                new RsApplication{ Id = 3,  Number = "6920", Department = "PC09", Market = "DE", ApplicationStatus = new RsApplicationStatus{ Type = RsApplicationStatusType.Approved }, Project = _projects[1], Candidate = _people[0], ProjectManager = _people[4], Smd = _people[4], CandidateDescription = description, Specialty = new Specialty{ Type = SpecialtyType.Developer }, Qualification = new Qualification{ Type = QualificationType.Senior}, Rate = _rates[0], BeginDate = new DateTime(2018, 1, 9),  EndDate = new DateTime(2018, 1, 9)   },
                new RsApplication{ Id = 4,  Number = "6921", Department = "PC09", Market = "DE", ApplicationStatus = new RsApplicationStatus{ Type = RsApplicationStatusType.Approved }, Project = _projects[2], Candidate = _people[0], ProjectManager = _people[2], Smd = _people[5], CandidateDescription = description, Specialty = new Specialty{ Type = SpecialtyType.Developer }, Qualification = new Qualification{ Type = QualificationType.Staff }, Rate = _rates[0], BeginDate = new DateTime(2018, 1, 11), EndDate = new DateTime(2018, 1, 12)  },
                new RsApplication{ Id = 5,  Number = "6934", Department = "PC09", Market = "DE", ApplicationStatus = new RsApplicationStatus{ Type = RsApplicationStatusType.Approved }, Project = _projects[3], Candidate = _people[0], ProjectManager = _people[3], Smd = _people[5], CandidateDescription = description, Specialty = new Specialty{ Type = SpecialtyType.Developer }, Qualification = new Qualification{ Type = QualificationType.Senior}, Rate = _rates[0], BeginDate = new DateTime(2018, 1, 15), EndDate = new DateTime(2018, 1, 15)  },
                new RsApplication{ Id = 6,  Number = "7050", Department = "PC09", Market = "DE", ApplicationStatus = new RsApplicationStatus{ Type = RsApplicationStatusType.Approved }, Project = _projects[2], Candidate = _people[0], ProjectManager = _people[2], Smd = _people[5], CandidateDescription = description, Specialty = new Specialty{ Type = SpecialtyType.Developer }, Qualification = new Qualification{ Type = QualificationType.Staff }, Rate = _rates[0], BeginDate = new DateTime(2018, 2, 12), EndDate = new DateTime(2018, 2, 16)  },
                ...
                new RsApplication{ Id = 12, Number = "7516", Department = "PC09", Market = "DE", ApplicationStatus = new RsApplicationStatus{ Type = RsApplicationStatusType.Approved }, Project = _projects[2], Candidate = _people[0], ProjectManager = _people[2], Smd = _people[5], CandidateDescription = description, Specialty = new Specialty{ Type = SpecialtyType.Developer }, Qualification = new Qualification{ Type = QualificationType.Staff }, Rate = _rates[0], BeginDate = new DateTime(2018, 5, 21), EndDate = new DateTime(2018, 5, 28)  },
                ...
                new RsApplication{ Id = 14, Number = "7630", Department = "PC09", Market = "DE", ApplicationStatus = new RsApplicationStatus{ Type = RsApplicationStatusType.Approved }, Project = _projects[2], Candidate = _people[0], ProjectManager = _people[2], Smd = _people[5], CandidateDescription = description, Specialty = new Specialty{ Type = SpecialtyType.Developer }, Qualification = new Qualification{ Type = QualificationType.Staff }, Rate = _rates[1], BeginDate = new DateTime(2018, 6, 6),  EndDate = new DateTime(2018, 6, 6)   },
                ...
                new RsApplication{ Id = 21, Number = "7832", Department = "PC09", Market = "DE", ApplicationStatus = new RsApplicationStatus{ Type = RsApplicationStatusType.Approved }, Project = _projects[2], Candidate = _people[0], ProjectManager = _people[2], Smd = _people[5], CandidateDescription = description, Specialty = new Specialty{ Type = SpecialtyType.Developer }, Qualification = new Qualification{ Type = QualificationType.Staff }, Rate = _rates[0], BeginDate = new DateTime(2018, 7, 27), EndDate = new DateTime(2018, 7, 30)  },
